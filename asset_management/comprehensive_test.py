...
try:
    ...
    nav_items = [
        ...
        ("⚠️ Несоответствия", "Несоответствия"),
        ("📋 Факт", "Факт"),
...
# Итоги
print(f"\n=== РЕЗУЛЬТАТЫ ===")
print(f"Импорт факта: {'✅ Работает' if success1 else '❌ Проблемы'}")
print(f"Бух отчетность: {'✅ Работает' if success2 else '❌ Проблемы'}")
print(f"История изменений: {'✅ Работает' if success3 else '❌ Проблемы'}")
print(f"Навигация: {'✅ Работает' if success4 else '❌ Проблемы'}")
