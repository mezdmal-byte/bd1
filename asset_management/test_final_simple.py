...
print("=== ФИНАЛЬНЫЙ ТЕСТ ИМПОРТОВ ===")

# Тест 1: Импорт бух отчетности
print("\n1. Импорт бух отчетности:")
...
try:
    ...
    with urllib.request.urlopen(req) as response:
        ...
        if 'Сопоставление колонок' in result:
            print("  OK: Страница сопоставления открыта")
        else:
            print("  FAIL: Страница сопоставления НЕ открыта")
...
print("Оба импорта должны показывать 'OK: Страница сопоставления открыта'")
